...
module.exports = function (grunt) {
    ...
    var yeomanConfig = {
        app: 'app',
        dist: 'template-dist'// gaeWebappPath+'/_templates/lp/bright-theme/lp-bright-theme-video-offer-content-v1/'//'dist'   //'~/dev/src/bower-local/angular-edit-inline/angular-edit-inline-demo/app/magnet-template/dist'//
    };
    try {
    ...
    var currTemplPath="/lp/bright-theme/lp-bright-theme-video-offer-content-v1"
    ...
    grunt.registerTask('newTemplateInitConfig', function(tempType,tempGroup,tempName) {
        ...
        // set old values from prev. new values above or to /tempType/tempGroup/tempName : /lp/bright-theme/lp-bright-theme-video-offer-content-v1
